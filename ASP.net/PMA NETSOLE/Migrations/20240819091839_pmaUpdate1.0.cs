...
{
    /// <inheritdoc />
    public partial class pmaUpdate10 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PastDesignation = table.Column<string>(type: "text", nullable: false),
                    Image = table.Column<byte[]>(type: "bytea", nullable: false),
                    TasksAssigned = table.Column<int>(type: "integer", nullable: false),
                    TasksPending = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentName = table.Column<string>(type: "text", nullable: false),
                    TaskCounts = table.Column<int>(type: "integer", nullable: false),
                    CompletedTasks = table.Column<List<string>>(type: "text[]", nullable: false),
                    AssignedEmployees = table.Column<List<string>>(type: "text[]", nullable: false),
                    PdfFileUrl = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false),
                    AssignedEmployeeName = table.Column<string>(type: "text", nullable: false),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: false),
